...
i have loaded and cleaned the data in pols-month.csv, as well as separated the column "mon" into "year", "month" and day". I also converted the "month" variable into a numeric variable. 
...
__last part on: This process will involve switching from “wide” to “long” format; ensuring that key variables have the same name; and ensuring that key variables take the same values__
