...
We need to use relative paths. The benefit is that it is easier and
other people can use it. Versus absolute dataset.
...
We could all of the janitor package. But we only want the clean_names
function. So we can use “package_name::”.
...
**Skimmer is super important to explore NA in data, also mean/sd etc**
...
We can use “?read_excel”. We can specify sheet, and range to import. And
which cell values, using range.
